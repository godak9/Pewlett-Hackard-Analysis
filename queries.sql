...
-- Creating employee count by department number table
...
--Creating current retirement employee info table
SELECT e.emp_no,
    e.first_name,
	e.last_name,
    e.gender,
